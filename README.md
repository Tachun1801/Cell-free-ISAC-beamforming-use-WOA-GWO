...
[![Run MATLAB Simulation](https://github.com/Tachun1801/Cell-free-ISAC-beamforming-use-WOA-GWO/actions/workflows/run-matlab-simulation.yml/badge.svg)](https://github.com/Tachun1801/Cell-free-ISAC-beamforming-use-WOA-GWO/actions/workflows/run-matlab-simulation.yml)
...
This repository includes a GitHub Actions workflow that automatically runs MATLAB simulations and saves results as artifacts.

#### Automatic Triggers

The simulation workflow runs automatically when:
- **Push to main branch**: Any push that modifies `.m` files triggers the simulation
- **Manual trigger**: Can be triggered manually from the Actions tab

#### How to Manually Trigger the Workflow

1. Go to the **Actions** tab in this repository
2. Select **Run MATLAB Simulation** from the left sidebar
...
4. Download the `simulation-results-<run_number>` artifact containing all output files

The artifacts include:
- All `.mat` files generated by the simulation
- Results are retained for 30 days

#### Notes on GitHub Actions MATLAB

- The workflow uses the official `matlab-actions/setup-matlab@v2` action
- MATLAB Parallel Computing Toolbox may have limited availability in GitHub Actions
- A timeout of 120 minutes is set for long-running simulations
